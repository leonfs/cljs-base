...
var seq__4278_4282 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__4279_4283 = null;
var count__4280_4284 = (0);
var i__4281_4285 = (0);
while(true){
if((i__4281_4285 < count__4280_4284)){
var str_4286 = cljs.core._nth.call(null,chunk__4279_4283,i__4281_4285);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),str_4286);

var G__4287 = seq__4278_4282;
var G__4288 = chunk__4279_4283;
var G__4289 = count__4280_4284;
var G__4290 = (i__4281_4285 + (1));
seq__4278_4282 = G__4287;
chunk__4279_4283 = G__4288;
count__4280_4284 = G__4289;
i__4281_4285 = G__4290;
continue;
} else {
var temp__4425__auto___4291 = cljs.core.seq.call(null,seq__4278_4282);
if(temp__4425__auto___4291){
var seq__4278_4292__$1 = temp__4425__auto___4291;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__4278_4292__$1)){
var c__3197__auto___4293 = cljs.core.chunk_first.call(null,seq__4278_4292__$1);
var G__4294 = cljs.core.chunk_rest.call(null,seq__4278_4292__$1);
var G__4295 = c__3197__auto___4293;
var G__4296 = cljs.core.count.call(null,c__3197__auto___4293);
var G__4297 = (0);
seq__4278_4282 = G__4294;
chunk__4279_4283 = G__4295;
count__4280_4284 = G__4296;
i__4281_4285 = G__4297;
continue;
} else {
var str_4298 = cljs.core.first.call(null,seq__4278_4292__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),str_4298);

var G__4299 = cljs.core.next.call(null,seq__4278_4292__$1);
var G__4300 = null;
var G__4301 = (0);
var G__4302 = (0);
seq__4278_4282 = G__4299;
chunk__4279_4283 = G__4300;
count__4280_4284 = G__4301;
i__4281_4285 = G__4302;
continue;
}
} else {
}
...
var args4305 = [];
var len__3340__auto___4308 = arguments.length;
var i__3341__auto___4309 = (0);
while(true){
if((i__3341__auto___4309 < len__3340__auto___4308)){
args4305.push((arguments[i__3341__auto___4309]));

var G__4310 = (i__3341__auto___4309 + (1));
i__3341__auto___4309 = G__4310;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args4305.length)].join('')));
...
return (function (){
if(cljs.core.truth_((function (){var and__2814__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__4315 = script;
goog.object.set(G__4315,"type","text/javascript");

goog.object.set(G__4315,"onload",onload);

goog.object.set(G__4315,"onreadystatechange",onload);

return G__4315;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__4316 = script__$1;
goog.object.set(G__4316,"src",src);

return G__4316;
})():(function (){var G__4317 = script__$1;
goog.dom.setTextContext(G__4317,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__2822__auto__ = reload;
...
var path_4318 = (goog.dependencies_.nameToPath[src]);
goog.object.remove(goog.dependencies_.visited,path_4318);

goog.object.remove(goog.dependencies_.written,path_4318);

goog.object.remove(goog.dependencies_.written,[cljs.core.str(goog.basePath),cljs.core.str(path_4318)].join(''));
} else {
}
